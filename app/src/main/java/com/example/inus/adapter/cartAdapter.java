...
import com.example.inus.Cart_screen;
import com.example.inus.R;
import com.example.inus.Shop_screen;
...
public class cartAdapter extends RecyclerView.Adapter<cartAdapter.MyViewHolder>{
    ...
    private String[] chobby ={"美妝保養","教育學習","居家婦幼","醫療保健","視聽娛樂","流行服飾","旅遊休閒","3C娛樂","食品"};
    private int Tpye;
    int no= 0;
        ...
        if (Tpye ==0){
            ...
            holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    db.collection("user/"+mAuth.getUid()+"/buy")
